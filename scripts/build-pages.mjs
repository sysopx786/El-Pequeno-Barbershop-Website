...
if (!existsSync(indexPath) || readFileSync(indexPath).byteLength === 0) {
  ...
  const base = "/El-Pequeno-Barbershop-Website/";
  writeFileSync(
    indexPath,
    `<!doctype html>
<html lang="en">
  <head>
    ...
    <title>El Pequeño Barbershop</title>
    <meta name="description" content="El Pequeño Barbershop — cuts, fades, and beards at 603 N 10th St, Reading, PA. Walk-ins welcome." />
